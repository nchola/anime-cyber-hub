          ...
          {results.length === 0 && query.length >= 2 ? (
            ...
            <>
              <div className="px-3 py-2 text-xs text-gray-400 border-b border-cyber-accent/10">
                Manga results for <span className="font-semibold text-cyber-accent">{query}</span>
              </div>
                  ...
                  <HoverCard>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-400 truncate">
                            {manga.status || 'Manga'}{manga.chapters ? `, ${manga.chapters} ch` : ''}
                          </div>
                        </div>
                      </div>
                    </HoverCardTrigger>
                    <HoverCardContent side="right" className="w-72 p-0 bg-cyber-background border border-cyber-accent/30 shadow-lg">
                      <div className="flex flex-col">
                        <img 
                          src={manga.images?.jpg?.large_image_url || manga.images?.jpg?.image_url || '/placeholder.svg'} 
                          alt={manga.title}
                        ...
                        />
                        <div className="p-3">
                          <h4 className="font-bold text-white">{manga.title}</h4>
                          ...
                          <p className="text-xs text-gray-300 line-clamp-3">{manga.synopsis || 'No synopsis available.'}</p>
                        </div>
                      </div>
                    </HoverCardContent>
                  </HoverCard>
